...
import time
from dataloder import load_sparse_tensor, sort_spare_tensor, scale_sparse_tensor
from dataloder import write_ply_ascii_geo, read_ply_ascii_geo
from pc import pc_error
...
if __name__ == '__main__':
    ...
    all_results = test(args.filedir, ckptdir_list, args.outdir, args.resultdir, scaling_factor=args.scaling_factor,
                       rho=args.rho, res=args.res)
